...
export default {
  'zh-cn': {
    'kylin.error.noCompilerAvailable':
      '没有编译器可用。请在 Turbowarp 上运行此脚本。',
  ...
  ja: {
    'kylin.error.noCompilerAvailable':
      'コンパイラーが見つかりません。Turbowarp でこのスクリプトを実行してください。',
    'kylin.error.gandi':
      'Gandi IDE はまだサポートされていません。Turbowarp でこのスクリプトを実行してください。',
