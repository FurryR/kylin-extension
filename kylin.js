...
${(await minify(
            `(${async function(Scratch2, version2, sourceMap) {
              ...
              const _setCompilerOptions = runtime2.setCompilerOptions;
              runtime2.setCompilerOptions = function(options) {
              ...
              IRGenerator.prototype.generate = function() {
                for (const block of Object.values(
                  ...
                  this.procedures["W" + signature] = this.procedures["Z" + signature] = {
              ...
              JSGenerator.prototype.createScriptFactory = function() {
                ...
                const topBlockNext = topBlock?.next ? this.target.blocks.getBlock(topBlock.next) : null;
                if (!topBlockNext) {
